        ...
        <div className="displayFlexBlock">
          <div className="section__criteria__left">
            <div className="section__criteria__left__text">
              We are looking for startups with the potential to grow to <span>Unicorn</span> concentrating our efforts
              on startups that are based in Silicon Valley or going to relocate to <span>Silicon Valley</span> or other
