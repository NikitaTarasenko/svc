  ...
  return (
    <div className="section s_about">
      <div className="s_about__left">
        ...
        <p>
          In 2021 we have reached a very important stage and invested in 28 startups overall. It was the year of our
          first US exit with Volumetric startup.
        </p>
      </div>
      <div className="s_about__right">
